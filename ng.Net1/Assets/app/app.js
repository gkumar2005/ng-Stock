...
app.config(['$routeProvider', '$locationProvider', '$httpProvider', function ($routeProvider, $locationProvider, $httpProvider) {
    ...
    // Routes
    //================================================
    $routeProvider.when('/stock', { templateUrl: 'App/Stock', controller: 'stockCtrl' });
    $routeProvider.when('/stockDetails', { templateUrl: 'App/StockDetails', controller: 'stockDetailCtrl' });
    $routeProvider.when('/', {
